<script setup>
import ParticalSphere from '@/Components/ParticalSphere.vue';
...
<template>
    ...
    <div class="relative min-h-screen bg-black overflow-hidden">
        ...
        <!-- Контент поверх фону -->
        <div class="flex flex-col items-center absolute inset-0 z-10 justify-center min-h-screen px-4">

            <!-- Логотип -->
            <img src="/images/logo.png" alt="Logo" class="w-32 h-32 mb-6 animate-fade-in" />

            <!-- Заголовок -->
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4 animate-slide-down">
                Ласкаво просимо!
            </h1>

            <!-- Опис -->
            <p class="text-lg text-gray-300 mb-8 text-center max-w-xl animate-fade-in-delay">
                Система обліку клієнтів і пенсійних виплат. Надійність. Точність. Комфорт.
            </p>

            <!-- Кнопки -->
            <div class="flex space-x-6 animate-fade-in-delay2">
                <Link href="/login"
                    class="px-8 py-3 bg-blue-600 text-white rounded-xl text-lg font-semibold hover:bg-blue-700 hover:scale-105 transition-all duration-300 shadow-lg">
                Увійти
                </Link>
                <Link href="/register"
                    class="px-8 py-3 bg-white text-blue-600 border border-blue-600 rounded-xl text-lg font-semibold hover:bg-blue-50 hover:scale-105 transition-all duration-300 shadow-lg">
                Зареєструватися
                </Link>
            </div>
